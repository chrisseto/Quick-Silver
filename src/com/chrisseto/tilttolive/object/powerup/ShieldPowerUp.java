...
public class ShieldPowerUp extends PowerUpBase {
	...
	public ShieldPowerUp(float pX, float pY,
			ITextureRegion pTextureRegion, VertexBufferObjectManager vbom,
			ActiveManager parent) {
		super(parent.getPlayer().getX(), parent.getPlayer().getY(), 40, pTextureRegion, vbom, parent, 0);
	}
	...
	protected void beginFinish() {
		this.registerEntityModifier(new AlphaModifier(1f,.7f,0,new IEntityModifierListener() {
